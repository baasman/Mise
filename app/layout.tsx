...
export const metadata: Metadata = {
  title: "Mise — a sous-chef, not a vending machine",
  description:
    "A creative recipe workspace. You build the dish; it reflects what's on the board and offers ideas you're always free to ignore.",
};
